...
if __name__ == "__main__":
    ...
    for i in range(0, 10):
        ...
        for j in range(5):
            ...
            # start training
            naive_digit.training(traingingSize)
            end_time = time.time()
            print("Training Complete")
            print("Training Time: "+str(end_time-start_time)+" Sec")
            print("Testing...")
            predicted_digit = naive_digit.get_predicted_digit()
    ...
    for i in range(0, 10):
        ...
        for j in range(5):
            ...
            start_time = time.time()
            # start training
            naive_face.training(trainingSize)
            end_time = time.time()
            print("Training Complete")
            print("Training Time: "+str(end_time-start_time)+" Sec")
            predicted_face = naive_face.get_predicted_face()
            timelist.append(end_time-start_time)
